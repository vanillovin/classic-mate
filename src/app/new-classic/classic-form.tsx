	...
	return (
		...
		>
			<input
				name="title"
				placeholder="title"
				className="rounded-sm border border-violet-200 p-1"
				required
			/>
			<input
				name="genre"
			...
			<textarea
				...
				className="rounded-sm border border-violet-200 p-1 h-16 max-h-24"
				required
			/>
			<input
				name="cover_image"
			...
			<input
				...
				className="border border-violet-200 p-1"
				required
			/>
			<button
				type="submit"
