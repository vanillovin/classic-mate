	...
	return (
		<div className="max-w-6xl mx-auto px-3 sm:px-6 pt-3 sm:pt-6 pb-24 flex flex-col gap-y-4">
			<section className="w-full flex flex-col sm:flex-row gap-2">
				...
				<div className="flex flex-row sm:flex-col w-full sm:w-4/12 md:w-3/12 gap-2">
					<ComposerCard composer={composer} />
					<ComposerInfoList composer={composer} />
				</div>
				<div className="w-full sm:w-8/12 md:w-9/12 px-4 py-8 bg-white/70 rounded-sm shadow-md">
...
function ComposerCard({ composer }: { composer: Composer }) {
	return (
		<div className="flex items-center justify-center w-5/12 sm:w-full h-[250px] sm:h-[350px] relative overflow-hidden rounded-sm shadow-md">
			<Image
				fill
...
function ComposerInfoList({ composer }: { composer: Composer }) {
	...
	return (
		<ul className="flex-1 flex flex-col justify-center sm:justify-start w-7/12 sm:w-full p-2 text-sm sm:text-base bg-black/90 text-white/90 rounded-sm shadow-md">
