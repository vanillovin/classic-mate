			...
			<div className="flex items-center justify-center sm:gap-4 flex-1 my-0 ">
				{data?.map((composer) => (
					...
					>
						...
						<div
							aria-hidden="false"
							className="absolute top-0 left-0 p-4 hidden group-hover:flex flex-col items-center justify-center font-light text-white text-center bg-black bg-opacity-60 w-full h-full"
						>
							{composer.shortDesc}
							<Link
