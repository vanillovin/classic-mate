	...
	return (
		<div className="w-full h-full mt-20 sm:mt-30 flex items-center justify-center">
			<div className="relative flex">
				...
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-3 flex items-end justify-center pb-1">
					{/* L */}
				</div>
				...
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-5 flex items-end justify-center pb-1">
					{/* O */}
				</div>
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-6 flex items-end justify-center pb-1">
					{/* A */}
				</div>
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-7 flex items-end justify-center pb-1">
					{/* D */}
				</div>
				...
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-9 flex items-end justify-center pb-1">
					{/* I */}
				</div>
				...
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-11 flex items-end justify-center pb-1">
					{/* N */}
				</div>
				...
				<div className="w-8 sm:w-10 h-20 sm:h-24 bg-white bg-opacity-70 border-r border-gray-100 animate-animate-piano-delay-13 flex items-end justify-center pb-1">
					{/* G */}
				</div>
